...
class Settings_Controller {
	...
	const HELLO_COMMERCE_CSS = 'hello_commerce_css';
	const HELLO_COMMERCE_THEME_CSS = 'hello_commerce_theme_css';
	...
	public static function get_default_setting(): array {
		...
		if ( is_null( $default_setting ) ) {
			$default_setting = [
				...
				self::HELLO_COMMERCE_CSS => apply_filters( self::SETTINGS_DEFAULT_FILTER_NAME . '/' . self::HELLO_COMMERCE_CSS, false ),
				self::HELLO_COMMERCE_THEME_CSS => apply_filters( self::SETTINGS_DEFAULT_FILTER_NAME . '/' . self::HELLO_COMMERCE_THEME_CSS, false ),
	...
	public static function should_skip_links(): bool {
		return self::get_option( self::SKIP_LINK );
	}

	public static function should_hide_header_footer(): bool {
		return self::get_option( self::HEADER_FOOTER );
	}

	public static function should_hide_page_title(): bool {
		return self::get_option( self::PAGE_TITLE );
	}

	public static function should_skip_hello_commerce_css(): bool {
		return self::get_option( self::HELLO_COMMERCE_CSS );
	}

	public static function should_skip_hello_commerce_theme_css(): bool {
		return self::get_option( self::HELLO_COMMERCE_THEME_CSS );
	}

	public static function should_skip_description_meta_tag(): bool {
	...
	public function enqueue_hello_plus_settings_scripts(): void {
		$screen = get_current_screen();

		if ( 'hello-commerce_page_hello-plus-settings' !== $screen->id ) {
			return;
		}

		$handle = 'hello-commerce-settings';
