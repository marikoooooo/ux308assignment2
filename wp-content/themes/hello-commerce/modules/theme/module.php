...
namespace HelloCommerce\Modules\Theme;
 ...
 * @subpackage HelloCommerceModules
 */
class Module extends Module_Base {
	const HELLO_COMMERCE_THEME_VERSION_OPTION = 'hello_commerce_theme_version';
	...
	public function scripts_styles() {
		if ( Settings_Controller::should_skip_hello_commerce_theme_css() ) {
			return;
		}

		wp_enqueue_style(
			'hello-commerce',
			HELLO_COMMERCE_STYLE_URL . 'theme.css',
			[],
		...
		if ( self::display_header_footer() ) {
			wp_enqueue_style(
				'hello-commerce-header-footer',
				HELLO_COMMERCE_STYLE_URL . 'header-footer.css',
				[],
				HELLO_COMMERCE_ELEMENTOR_VERSION
			);
		}
