...
const componentMap = {
	...
	AddPageIcon: () => import( '@elementor/icons/AddPageIcon' ),
	ChecklistIcon: () => import( '@elementor/icons/ChecklistIcon' ),
	AdjustmentsHorizontalIcon: () => import( '@elementor/icons/AdjustmentsHorizontalIcon' ),
	ToggleRightIcon: () => import( '@elementor/icons/ToggleRightIcon' ), // TODO: Check if this is correct
	CoinsIcon: () => import( '@elementor/icons/CoinsIcon' ),
	CalendarDollarIcon: () => import( '@elementor/icons/CalendarDollarIcon' ),
};
