...
$enable_skip_link = apply_filters( 'hello-plus-theme/enable_skip_link', ! \HelloCommerce\Modules\Settings\Components\Settings_Controller::should_skip_links() );
...
<a class="skip-link screen-reader-text" href="<?php echo esc_url( $skip_link_url ); ?>"><?php echo esc_html__( 'Skip to content', 'hello-commerce' ); ?></a>
<?php } ?>
